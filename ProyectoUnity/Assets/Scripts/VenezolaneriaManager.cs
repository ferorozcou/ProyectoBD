...
public class VenezolaneriaManager : MonoBehaviour
{
    ...
    private string[] instrucciones = { //Cadena de strings con las instrucciones.
        "�Bienvenido a Marico's Venezolaneria! �Qu� desea pedir?",
        ...
        "Cada pedido estar� conformado de una o varias arepas, as� como una bebida. Arrastra al plato los ingredientes de cada arepa y haz click sobre el bot�n" +
        ...
        "Una vez tengas todas las arepas y la bebida preparadas haz click sobre el bot�n con el tick para entregarlas.",
