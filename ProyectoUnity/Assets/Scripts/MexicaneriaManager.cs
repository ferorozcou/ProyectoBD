...
public class MexicaneriaManager : MonoBehaviour
{
    ...
    private string[] instrucciones = { //Cadena de strings con las instrucciones.
        "¡Bienvenido a Wey's Mexicaneria! ¿Qué desea pedir?",
        ...
        "Cada pedido estará conformado de una o varios sopes, así como una bebida. Arrastra al plato los ingredientes de cada sope y haz click sobre el botón" +
        ...
        "Una vez tengas todas los sopes y la bebida preparados haz click sobre el botón con el tick para entregarlas.",
