...
public class EspanoleriaManager : MonoBehaviour
{
    ...
    private string[] instrucciones = { //Cadena de strings con las instrucciones.
        "�Bienvenido a Tio's Espa�oleria! �Qu� desea pedir?",
        ...
        "Cada pedido estar� conformado de una o varias tortillas, as� como una bebida. Arrastra al plato los ingredientes de cada tortilla y haz click sobre el bot�n" +
        ...
        "Una vez tengas todas las tortillas y la bebida preparadas haz click sobre el bot�n con el tick para entregarlas.",
